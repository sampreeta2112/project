			...
			<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post"  enctype="multipart/form-data">
				...
				<div class="col-sm-5">
					...
					<div class="form-group">
						<label>flag</label>
						<select class="form-control" name="txticat_id" id="txticat_id" required/>
						...
						<?php
						foreach($subcat_arr as $icat_id => $icat_val)
						{
							?>
							<option value="<?php echo $icat_id ?>" <?php if($icat_id==$txticat_id) echo "selected" ?> ><?php echo $icat_val ?></option>
							<?php
						}
						?>
						</select>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="txtitem_name" name="txtitem_name" value="<?php echo $txtitem_name ?>" placeholder="Enter Item Name..." required/>
					</div>
