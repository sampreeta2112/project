...
if($txtname!='')
{
    ...
    $cond.=" and client_name like '%$txtname1%' ";
	$flag = true;
}

$_SESSION[SES_ADMIN]->cat_url_str=$url_str;
$_SESSION[SES_ADMIN]->cat_cond=$cond;
...
$count=GetSingleValue("select count(*) from client_master  where 1 $cond");
			...
			<div class="col-sm-12" id="outer">
				...
				<div class="row">
					<div class="col-sm-11" style="overflow-y:scroll;height:400px;">
					  <h3>Flags Master <a  href="<?php echo $edit_url;?>"><?php echo IMG_ADD ?></a></h3>
						...
						<table width="100%" align="center" border="0" cellspacing="1" cellpadding="1" class="tbl-cont" >
						  ...
						  <tbody>
							<?php
								$q = "select * from client_master  where 1 $cond";
