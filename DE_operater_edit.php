			...
			<form action="<?php echo $_SERVER['PHP_SELF'] ?>" method="post"  enctype="multipart/form-data">
				...
				<div class="col-sm-5">
					...
					<div class="form-group">
						<label>SHIPS NAME</label>
						<input type="text" class="form-control" id="txtclient_name" name="txtclient_name" value="<?php echo $txtclient_name ?>" placeholder="Enter Name..." required/>
					</div>
				
					<div class="form-group">
					<label>SHIPS EMAILS</label>
						<input type="text" class="form-control" id="txtclient_name" name="txtclient_name" value="<?php echo $txtclient_name ?>" placeholder="Enter Name..." required/>
					</div>
					
					<div class="form-group">
						<label>flag</label>
						<Select class="form-control" name="txtregion" id="txtregion" required/>
                       ...
                       <div class="form-group">
						...
						<option value="">SUPERTANDANT</option>
					...
					<div class="form-group">
						...
						<input type="text" class="form-control" id="username" name="username" value="<?php echo $txtusername ?>" placeholder="Username" />
					</div>
					<div class="form-group">
						<label> SET Password.:</label>
						<input type="text" class="form-control" id="pass_word" name="pass_word" value="<?php echo $txtpassword ?>" placeholder="Password" <?php if($mode!="E")echo"required";?>/>
					</div>
					<div class="form-group">
